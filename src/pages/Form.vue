<template>
<div>
  <q-list bordered class="rounded-borders" v-if="isReady"> <q-tooltip>点击展开</q-tooltip>
  <q-expansion-item
    expand-separator
  ...
  >
    <q-card ><static-table :data="dataPaid" rowKey="year" title="课程缴费" :columns="paidSum"></static-table>
      <br><static-table :data="dataTraining" title="练琴缴费" rowKey="year" :columns="paidSum"></static-table>
    </q-card>
  </q-expansion-item>
    <q-expansion-item
      expand-separator
    ...
    >
      <q-card><static-table :data="dataPG" rowKey="id" title="课程缴费" :columns="paidGroupByStudent"></static-table>
        <br><static-table :data="dataTG" title="练琴缴费" rowKey="id" :columns="paidGroupByStudent"></static-table>
      </q-card>
    </q-expansion-item>
  <q-expansion-item
    expand-separator
  ...
  >
    <q-card><static-table :data="dataPaidDetail" title="课程缴费" rowKey="id" :columns="paidList"></static-table>
      <br><static-table :data="dataTrainingDetail" title="练琴缴费" rowKey="id" :columns="trainingList"></static-table>
    </q-card>
  </q-expansion-item>
